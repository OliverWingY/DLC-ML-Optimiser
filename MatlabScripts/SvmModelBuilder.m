...
SupportVectorMachineResponse = fitrsvm(CoatingData, 'Hardness', 'KernelFunction','gaussian', 'Standardize',true);


plotPartialDependence(SupportVectorMachineResponse, [3,2])

ds = tabularTextDatastore('CoatingData.csv');